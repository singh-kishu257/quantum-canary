...
MethodTest AUCNotesPer-feature majority-vote threshold0.7586Naive baselineHotelling's T² (multivariate SPC, 1947)0.7674Rigorous statistical baselineQuantum Canary MLP ensemble0.9239+20.4% over Hotelling T²
Quantum Canary anticipated 3 of 3 IBM recalibration events with an average lead time of 3.34 hours.

Install
bashpip install quantum-canary
...
pythonfrom quantum_canary import Canary
...
pythonfrom quantum_canary import MLPEnsemble
import numpy as np
...
bash# Option A — environment variables (recommended for scripts)
...
Bell state circuit — measures 2-qubit entanglement fidelity (F_bell)
Coherence circuit (20× H identity) — measures T2 dephasing (F_coherence)
Gate-error circuit (20× X identity) — measures single-qubit gate accumulation (F_gate)
...
For reproducing the paper end-to-end, see research/README.md.
...
bibtex@misc{singh2026quantumcanary,
