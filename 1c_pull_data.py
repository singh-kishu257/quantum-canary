# 1c_pull_data.py — Quantum Canary Prototype 2 (Extra Qubits)
# Pulls qubits 10-19 from 3 backends, same 200-day window.
# Zero overlap with 1_pull_data.py (qubits 0-9) and 1b_pull_data.py (older dates).
# Target: ~6,000 new rows appended to all_backends_raw.csv
...
for backend_name in BACKENDS:
    ...
    path = f"data/{backend_name}_qubits10-19.csv"
...
if all_dfs:
    ...
    print(f"  ✓ Updated: data/all_backends_raw.csv")
